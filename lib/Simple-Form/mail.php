<?php
	...
	$simpleFormMailRecipient = "sp@readymotors.ru, info@readymotors.ru";
	$simpleFormMailFrom = "landing@readymotors.ru";
	$simpleFormMailSubject = "Новый лид";
	$simpleFormSuccessMessage = "Спасибо! Ваше сообщение отправлено!";
